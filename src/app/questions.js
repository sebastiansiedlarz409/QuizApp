const questions = [
  ...
  {
    question:
      "Wzorcem projektowym, który agreguje funkcjonalności mniejszych klas w jedną jest?",
    url: "",
    a1: "fasada",
    a2: "dekorator",
    a3: "odwiedzający",
  ...
  {
    question:
      "Wzorcem projektowym służącym do adaptacji nowego api w stare jest?",
    url: "",
    a1: "adapter",
    a2: "dekorator",
    a3: "fasada",
  ...
  {
    question:
      "Zawsze najpierw projektuje się bazę danych a później kod do niej?",
    url: "",
    a1: "NIE",
    a2: "TAK",
    a3: "",
  ...
  {
    question:
      "Kompozycja jest bardziej mobilna i elastyczna niż dziedziczenie?",
    url: "",
    a1: "TAK",
    a2: "NIE",
    a3: "",
  ...
  {
    question:
      "Dane otrzymywane poprzez protokoły HTTP/HTTPS mogą być w formacie?",
    url: "",
    a1: "wszystkie wymienione",
    a2: "JSON",
    a3: "XML",
  ...
  {
    question:
      'W JS wynikiem operacji "console.log("This is a string." instanceof String);" będzie?',
    url: "",
    a1: "false",
    a2: "true",
    a3: "",
  ...
  {
    question:
      "W JS wynikiem operacji \"console.log(('b' + 'a' + + 'a' + 'a').toLowerCase());\" będzie?",
    url: "",
    a1: "banana",
    a2: "baaa",
    a3: "ananas",
  ...
  {
    question:
      "W JS wynikiem operacji \"['1', '7', '11'].map(parseInt)\" będzie?",
    url: "",
    a1: "[1, NaN, 3]",
    a2: "[1, 7, 11]",
    a3: "[0, 6, 10]",
  ...
  {
    question:
      'W JS zmienna zadeklarowana jako "var" jest przypisana do przestrzeni funkcji',
    url: "",
    a1: "TAK",
    a2: "NIE",
    a3: "",
  ...
  {
    question:
      'W JS zmienna zadeklarowana jako "let" jest przypisana do przestrzeni funkcji',
    url: "",
    a1: "NIE",
    a2: "TAK",
    a3: "",
  ...
  {
    question:
      "Jeżeli usuniemy z bazy rekord to jego klucz główny (ID) może zostać użyty ponownie?",
    url: "",
    a1: "NIE",
    a2: "TAK",
    a3: "",
  ...
  {
    question:
      "Bazy danych pozwalają automatyzować generowanie klucza głównego za pomocą...",
    url: "",
    a1: "sekwencji",
    a2: "procedur",
    a3: "funkcji",
  ...
  {
    question:
      "Mechanizem pozwalającym szybko modyfikować bazę danych i migrować dane między jej wersjami w czasie dewelopmentu to",
    url: "",
    a1: "migracje",
    a2: "transakcje",
    a3: "encje",
  ...
  {
    question:
      "Zestaw czynności na bazie danych, które stanowią pewną nierozerwalną całość to",
    url: "",
    a1: "transakcje",
    a2: "migracje",
    a3: "procedury",
  ...
  {
    question:
      "Jeżeli przechowujemy w tablii cenę brutto, netto i tara jednocześnie to łamiemy?",
    url: "",
  ...
  {
    question:
      "Najbardziej prawdopodobna relacja między tabelami Osoba oraz Adres to relacja?",
    url: "",
    a1: "wiele do wielu",
    a2: "jeden do wielu",
    a3: "wiele do jednego",
  ...
  {
    question:
      "Najbardziej prawdopodobna relacja między tabelami Student oraz ContactData to relacja?",
    url: "",
    a1: "jeden do jeden",
    a2: "jeden do wielu",
    a3: "wiele do jednego",
  ...
  {
    question:
      'Aby w SQL uzyskać wyniki gdzie wartość kolumny n na drugim miejscu ma literkę "r" trzeba użyć klauzuli?',
    url: "",
    a1: "like '_r%'",
    a2: "like '?r%'",
    a3: "like '*r%'",
  ...
  {
    question:
      "Instrukcja, która w PHP posłuży do napisania programu typu HelloWorld to?",
    url: "",
    a1: "echo",
    a2: "print",
    a3: "write",
  ...
  {
    question:
      "W php aby zaimportować funkcjonalnośc jednego pliku do drugiego należy posłużyć się składnią?",
    url: "",
    a1: "include 'code.php';",
    a2: "include<code.php>;",
    a3: "include(code.php);",
  ...
  {
    question:
      'W PHP funkcje "die()" oraz "exit()" wykonują dokładnie to samo zadanie?',
    url: "",
    a1: "TAK",
    a2: "NIE",
    a3: "",
  ...
  {
    question:
      'W PHP funkcje "max()" oraz "min()" przyjmują nieokreśloną ilość parametrów?',
    url: "",
    a1: "TAK",
    a2: "NIE",
    a3: "",
